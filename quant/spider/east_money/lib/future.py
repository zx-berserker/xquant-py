...
def futures_hist_separate_char_and_numbers_em(symbol: str = "焦煤2506") -> tuple:
    """
    ...
    char = None
    number = None
    chars = re.findall(pattern="[\u4e00-\u9fa5a-zA-Z]+", string=symbol)
        ...
        for num in range(1, len(inner_data_json) + 1):
            ...
            if len(r_data_json) > 0:
                ...
                all_exchange_symbol_list.append({
                    "code": fi_code,
                    "mktid": fi_mktid,
                    "mktname": r_data_json[0]["mktname"],
                    "mktshort": r_data_json[0]["mktshort"],
                    "name": fi_name,
                    "vcode": fi_code,
                    "vname": fi_name,
                })
...
def futures_hist_em(
    ...
    try:
        ...
        symbol_char, numbers = futures_hist_separate_char_and_numbers_em(symbol)
...
if __name__ == "__main__":
    ...
    futures_hist_em_df = futures_hist_em(symbol="cufi", period="daily")
    print(futures_hist_em_df)
    # print(futures_hist_separate_char_and_numbers_em())